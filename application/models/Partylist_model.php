<?php
    class Partylist_model extends CI_Model {
        ...
        {
            $this->db->update('partylist', $data, $where);
        ...
        public function check_partylist_exists($partylist){
            $query = $this->db->get_where('partylist', array(
                'name' => $partylist
            ));
