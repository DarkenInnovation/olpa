...
function x_navigation_minimize(action){
    ...
    if(action == 'open'){
        $(".page-container").removeClass("page-container-wide");
        $(".page-sidebar .x-navigation").removeClass("x-navigation-minimized");
        $(".x-navigation-minimize").find(".fa").removeClass("fa-arrow-circle-o-right").addClass("fa-arrow-circle-o-left");
    ...
    if(action == 'close'){
        ...
        $(".x-navigation-minimize").find(".fa").removeClass("fa-arrow-circle-o-left").addClass("fa-arrow-circle-o-right");
